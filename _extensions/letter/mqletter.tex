...
\vskip.3cm
\scalebox{1.6}{\includegraphics[height=2cm]{SoMAPS}}
\end{textblock}%
\begin{textblock}{4}(14.6,1)
\scalebox{1.3}{\includegraphics[height=1.5cm]{MQ-logo-col.png}}
\end{textblock}%

\def\thepage{}}

\@ifundefined{opening}{}{%
\renewcommand*{\opening}[1]{\thispagestyle{macquarie}%
   {\@date\par}%
  \vspace{2\parskip}%
...
\setstretch{1}
\vspace*{2.5cm}\enlargethispage*{-2cm}
\opening{$opening$}
\setstretch{$spacing$}
$body$
\bigskip
